...
const APP_SHELL = [
  '/mapper/',
  '/mapper/index.html',
  '/mapper/manifest.webmanifest',
  '/mapper/assets/css/mapper.css',
  '/mapper/assets/js/mapper.js',
  '/mapper/assets/icons/icon-192.png',
  '/mapper/assets/icons/icon-512.png'
];
...
self.addEventListener('fetch',event=>{
 ...
 if(request.mode==='navigate'){event.respondWith(fetch(request).catch(()=>caches.match('/mapper/index.html')));return}
